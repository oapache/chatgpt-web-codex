...
const en = {
  ...
  devConnectorIsolationNotice: "Create a separate connector with the exact DEV name below. Keep Codex Native4 unchanged so production and repository development can run side by side.",
  ...
  zeroRiskDefaultProfileBody: "Install only ChatGPT + Codex Zero Risk.",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "Also install ChatGPT + Codex Zero Risk Pro.",
  ...
  connectorMigrationNotice: "Upgrading from Codex Native? Leave the old connector untouched and create Codex Native4 as a new connector. Do not rename or refresh Codex Native. Verify runtime rejects a legacy-only setup.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "请使用下方准确的 DEV 名称新建独立连接器。保留 Codex Native4 不变，让生产使用和仓库开发可以同时运行。",
  ...
  zeroRiskDefaultProfileBody: "仅安装 ChatGPT + Codex Zero Risk。",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "同时安装 ChatGPT + Codex Zero Risk Pro。",
  ...
  connectorMigrationNotice: "从 Codex Native 升级？请保留旧连接器不变，并新建名为 Codex Native4 的连接器。不要重命名或刷新 Codex Native。仅有旧连接器时，运行时验证会明确失败。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "下記の正確な DEV 名で個別のコネクタを作成してください。Codex Native4 は変更せず、本番利用とリポジトリ開発を並行して実行できる状態を保ちます。",
  ...
  zeroRiskDefaultProfileBody: "ChatGPT + Codex Zero Risk のみをインストールします。",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "ChatGPT + Codex Zero Risk Pro もインストールします。",
  ...
  connectorMigrationNotice: "Codex Native からアップグレードする場合は、古いコネクタを変更せず、新しい Codex Native4 コネクタを作成してください。Codex Native の名前変更や更新は行わないでください。古いコネクタしかない場合、ランタイム検証は明示的に失敗します。",
