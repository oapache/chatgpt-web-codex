...
1. Install the [latest release](https://github.com/oapache/chatgpt-web-codex/releases/latest). Quit
...
- Passkey-only macOS accounts have a known open issue.
  If no alternate method exists, do not repeatedly delete the browser profile; there is no safe
  generic workaround to claim yet.
