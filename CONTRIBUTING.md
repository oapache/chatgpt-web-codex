...
ChatGPT Web + Codex is developed and maintained by [@oapache](https://github.com/oapache).
Product direction, architecture, and release decisions remain with the maintainer.
